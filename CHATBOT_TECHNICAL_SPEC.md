...
### 5.1 System Design
*   **Microservice Pattern:** `chatbot-service` runs as an independent Node.js/Express application on port `5001`.
...
*   **Port Config:** Configurable via `PORT` env var (Default: 5001).
