...
import { Trash2, Check, CreditCard, Download, Zap, Crown, Plus, Smartphone, X, FileText, Clock, Video, Mail, Scan, ChevronUp, ChevronDown } from 'lucide-react';
                ...
                activeTab === 'credits' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="flex justify-center border-t border-gray-100 pt-6">
                            ...
                            >
                                {showCreditHistory ? <Clock size={16} /> : <Clock size={16} />}
                                {showCreditHistory ? 'Hide Credit History' : 'Show Credit History'}
                                {showCreditHistory ? <ChevronUp size={14} /> : <ChevronDown size={14} />}
                            </button>
                        </div>
                                    ...
                                    <ul className="space-y-3 mb-8 flex-1">
                                        {['Up to 10 meetings/month', '50 contacts', 'Basic analytics', 'Email support'].map((feature, i) => (
                                            <li key={i} className="flex items-start">
                                                <span className="mr-2 flex-shrink-0 mt-0.5"><Check size={18} className="text-green-500" /></span>
                    ...
                    <Card title="Payment Method" description="Manage your payment instruments and billing details.">
                        ...
                        <div className="space-y-3 mb-8">
                                ...
                                <div key={method.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-white hover:border-blue-300 transition-colors">
                                    <div className="flex items-center space-x-4">
                                        <div className={`p-3 rounded-md ${method.type === 'card' ? 'bg-gray-100' : 'bg-green-50'}`}>
                                            {method.type === 'card' ? <CreditCard size={24} className="text-gray-600" /> : <Smartphone size={24} className="text-green-600" />}
                                        </div>
                                        <div>
                            ...
                            {isAdmin && (
                                ...
                                >
                                    <span className="mr-2"><Plus size={20} /></span> Add Payment Method
                                </button>
                            )}
                        </div>
                            ...
                            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 animate-fade-in">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex p-1 bg-gray-100 rounded-lg mb-6">
                                        ...
                                        >
                                            <span className="mr-2"><CreditCard size={16} /></span> Card
                                        </button>
                                        <button
                                        ...
                                        >
                                            <span className="mr-2"><Smartphone size={16} /></span> UPI
                                        </button>
                                    </div>
