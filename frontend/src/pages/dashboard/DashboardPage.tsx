        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <div className="fixed top-0 left-0 right-0 bg-gradient-to-r from-blue-500 to-cyan-600 text-white p-3 z-50 flex items-center justify-between shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="http://localhost:3004/chatbot.html"
                className="px-4 py-1.5 bg-white text-blue-600 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors"
              >
                Chatbot :3004
              </a>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card className="hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-2 bg-blue-50 rounded-lg"><Briefcase size={20} className="text-blue-600" /></div>
                  </div>
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-2 bg-purple-50 rounded-lg"><ClipboardList size={20} className="text-purple-600" /></div>
                  </div>
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-2 bg-orange-50 rounded-lg"><Calendar size={20} className="text-orange-600" /></div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  ...
                  <div className="space-y-3">
                    <button className="w-full p-3 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition-colors text-left font-medium text-sm flex items-center gap-3">
                      <Mail size={18} /> Send Email Campaign
                    </button>
                    <button className="w-full p-3 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors text-left font-medium text-sm flex items-center gap-3">
                      <UserPlus size={18} /> Add New Lead
                    </button>
                    <button className="w-full p-3 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-colors text-left font-medium text-sm flex items-center gap-3">
                      <BarChart size={18} /> Generate Report
                    </button>
                    <a href="http://localhost:3003/settings.html" className="w-full p-3 bg-gray-50 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors text-left font-medium text-sm flex items-center gap-3">
